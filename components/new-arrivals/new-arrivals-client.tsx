...
export default function NewArrivalsClient({ initialView }: { initialView?: "compact" | "comfortable" }) {
  ...
  const [compact, setCompact] = useState(initialView ? initialView === "compact" : true)
